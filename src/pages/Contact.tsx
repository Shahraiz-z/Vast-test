    ...
    <div className={`${isAr ? 'font-arabic' : ''}`} dir={dir}>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                ...
                {submitted ? (
                  <div className="flex items-center gap-3 p-6 bg-green-50 rounded-xl text-green-700">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className={`w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#237357] focus:ring-2 focus:ring-[#237357]/20 outline-none transition-all ${isAr ? 'text-right' : 'text-left'}`}
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          className={`w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#237357] focus:ring-2 focus:ring-[#237357]/20 outline-none transition-all bg-white ${isAr ? 'text-right' : 'text-left'}`}
                        >
                          <option value="">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={5}
                        className={`w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#237357] focus:ring-2 focus:ring-[#237357]/20 outline-none transition-all resize-none ${isAr ? 'text-right' : 'text-left'}`}
                    ...
                    <button
                      type="submit"
                      className={`inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-[#237357] text-white font-semibold hover:bg-[#1a5a43] transition-all duration-200 ${isAr ? 'flex-row-reverse' : ''}`}
                    >
            ...
            <div>
              <div className="bg-[#237357] rounded-2xl p-8 text-white">
      ...
      <section className="py-10 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg h-[400px] bg-gray-200 relative">
            <iframe
