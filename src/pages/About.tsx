          ...
          <div className={`grid lg:grid-cols-2 gap-12 items-center`}>
            ...
            <div className={isAr ? 'order-1' : 'order-2'}>
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-6 -left-6 bg-[#87C24D] rounded-xl p-6 shadow-lg hidden sm:block">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-shadow duration-300 border border-gray-100 text-center"
              >
                <div className="w-16 h-16 rounded-full bg-[#237357]/10 flex items-center justify-center mb-4 mx-auto">
