              ...
              return (
                ...
                >
                  <div className={`flex items-start gap-6 ${isAr ? 'flex-row-reverse text-right' : 'text-left'}`}>
                    <div className="w-16 h-16 rounded-xl bg-[#237357]/10 flex items-center justify-center flex-shrink-0">
            ...
            {t.services.process.steps.map((step, index) => {
              ...
              return (
                <div key={index} className="relative text-center">
                  {/* Step Number */}
                  <div className="w-20 h-20 rounded-full bg-[#237357] flex items-center justify-center mx-auto mb-4 relative z-10">
                  ...
                  <div className="w-8 h-8 rounded-full bg-[#87C24D] text-white text-sm font-bold flex items-center justify-center mx-auto mb-3">
                    {index + 1}
                  </div>
