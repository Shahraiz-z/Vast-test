    ...
    <div className={`${isAr ? 'font-arabic' : ''}`} dir={dir}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div className={`max-w-2xl ${isAr ? 'mr-auto text-right' : 'ml-auto text-left'}`}>
              ...
              <div className={`flex flex-wrap gap-4 ${isAr ? 'justify-end' : 'justify-start'}`}>
                <Link
                  to="/catalog"
                  className={`inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#87C24D] text-white font-semibold hover:bg-[#6fa33d] transition-all duration-200 ${isAr ? 'flex-row-reverse' : ''}`}
                >
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-white/10 text-white font-semibold hover:bg-white/20 transition-all duration-200 border border-white/30 backdrop-blur-sm"
                >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {productOverview.map((item, index) => (
              <Link
                key={index}
                to={item.link}
                className="group relative h-[400px] sm:h-[500px] overflow-hidden rounded-lg cursor-pointer"
              >
                <img
                  src={item.src}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-20">
            {kitchenStyles.map((style, index) => (
              ...
              >
                {/* Image */}
                <div className={`relative overflow-hidden rounded-lg group ${style.reverse && !isAr ? 'lg:col-start-2' : ''}`}>
      ...
      <section className="py-20 bg-gradient-to-r from-[#237357] to-[#2d8a6a]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/contact"
            className={`inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-[#87C24D] text-white font-semibold text-lg hover:bg-[#6fa33d] transition-all duration-200 shadow-lg ${isAr ? 'flex-row-reverse' : ''}`}
          >
